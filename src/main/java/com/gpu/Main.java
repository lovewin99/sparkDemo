...
//    static{ System.loadLibrary("test"); }
    ...
    public static void main(String[] args) {
        System.setProperty("java.library.path","/home/wangxy/data/opencv-2.4.10/build/bin/");
//        System.loadLibrary(Core.NATIVE_LIBRARY_NAME);
        String imagesSequenceFile = "/media/disk2/dir_1.hsf"; //change this
        String metadataSequenceFile = "/media/disk2/dir_1_meta.hsf";  //change this
